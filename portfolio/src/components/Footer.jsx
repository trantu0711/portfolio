  ...
  return (
    <footer className="dark:bg-[#0b0b17] bg-slate-50 py-12 border-slate-800/50 transition-colors duration-300">
      <div className="container mx-auto px-6 text-center ">
        ...
        <p className="text-slate-600 duration-300 dark:text-slate-300 mb-10 max-w-5xl mx-auto leading-relaxed text-justify">
            {t('footer.quote')}
        </p>

        {/* Đường kẻ ngang mảnh */}
        <div className="w-full h-[1px] duration-300 dark:bg-slate-800 bg-slate-300 mb-8 max-w-5xl mx-auto"></div>
